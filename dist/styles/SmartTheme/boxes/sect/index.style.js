...
const style = function (props) {
  ...
  .sect {
    ...
    --metric-pad: ${(0, tamanhosMatriz_style_1.getTamanhosViaTamanhosMatriz)(ss.pad.default)};
    --metric-pad-tiny: ${(0, tamanhosMatriz_style_1.getTamanhosViaTamanhosMatriz)(ss.pad.tiny)};
    --metric-pad-compact: ${(0, tamanhosMatriz_style_1.getTamanhosViaTamanhosMatriz)(ss.pad.compact)};
    --metric-pad-loose: ${(0, tamanhosMatriz_style_1.getTamanhosViaTamanhosMatriz)(ss.pad.loose)};
    --metric-pad-expand: ${(0, tamanhosMatriz_style_1.getTamanhosViaTamanhosMatriz)(ss.pad.expand)};
    ...
    --metric-gap: ${(0, tamanhosMatriz_style_1.getTamanhosViaTamanhosMatriz)(ss.gap)};
